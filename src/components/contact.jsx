      ...
      <div className='grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
        <div>
          ...
          <p className="section-description">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Amet in quasi itaque molestiae illum voluptates quia modi, maxime, consequatur eveniet laboriosam et nam? Asperiores expedita consequatur ab quos. Distinctio, corrupti.
          </p>
