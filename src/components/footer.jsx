            ...
            <div className="app-container">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4 gap-12">
                    <div className='space-y-4'>
                        ...
                        <p className="footer-description">
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Ullam soluta quae dolorum ipsum voluptas earum tenetur a alias! Laudantium pariatur facere amet dicta reprehenderit iusto esse illum nam corrupti libero.
                        </p>
                ...
                <div className="footer-bottom-bar">
                    <p className="footer-bottom-text">
                        &copy; 2025 AI Revolution. All rights reserved.
                    </p>
